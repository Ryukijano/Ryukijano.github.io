...
/**
 * Page background: the Kanagawa latent jpg as ink multiplied onto washi.
 *
 * Not a figure and not a hero. A fixed viewport layer sits behind the
 * article; object-position pans left (painted) → right (wireframe) with
 * scroll, or eases toward a mode lock. Narrow viewports and reduced
...
const imgStyle = parseStyle(
  'position:absolute;inset:0;width:100%;height:100%;object-fit:cover;display:block;' +
    'object-position:var(--plate-pos, 20% 50%);mix-blend-mode:multiply;opacity:0.22',
);
