  ...
  ryukijano: {
    ...
    projects: [
      { 
        ...
        figure: {
          kind: 'image',
          src: '/assets/media/dalton-mills.gif',
      ...
      { 
        ...
        figure: {
          kind: 'image',
          src: '/assets/media/burgers-shock.gif',
          poster: '/assets/media/burgers-shock-poster.webp',
          width: 640,
          height: 360,
          alt: 'Forty-four stacked ink curves of Burgers’ equation, from a smooth sine wave at t = 0 to a sharp shock at x = 0 by t = 1.',
          caption: 'Burgers’ equation with ν = 0.01/π, drawn one time slice at a time: the sine wave steepens into a shock at x = 0.',
          scope: 'Exact solution by the Cole–Hopf transform, computed for this figure. It is the benchmark PINNs are fitted to, not output from the repository’s networks.',
        },
      ...
      },
      {
        ...
        figure: {
          kind: 'image',
          src: '/assets/media/b3tt3r-illustration.webp',
          width: 480,
          height: 270,
  ...
  ai: {
    ...
    projects: [
      { 
        ...
        figure: {
          kind: 'image',
          src: '/assets/media/esd-comparison.gif',
      ...
      { 
        ...
        figure: {
          kind: 'image',
          src: '/assets/media/vla-diffusion.gif',
      ...
      { 
        ...
        figure: {
          kind: 'image',
          src: '/assets/media/fetvae-prediction.gif',
          ...
          scope: 'Architecture schematic. The t=20 results are the repository’s reported JIGSAWS test-set figures; the shape of the quality-decay curve is illustrative.',
        },
      ...
      },
      {
        ...
        figure: {
          ...
          caption: 'A clay statue turning on a plain table, then turning back.',
      ...
      },
      {
        ...
        figures: [
          ...
          {
            kind: 'image',
            src: '/assets/media/pothole-blink.gif',
            poster: '/assets/media/pothole-blink-poster.webp',
            width: 400,
            height: 340,
            alt: 'Three dashcam frames, each shown at low resolution and then after ESRGAN in the same place, with the detector’s boxes changing.',
            caption: 'The same detector output, each frame alternated in place: low resolution, then after ESRGAN.',
            scope: 'Frames and boxes from Figure 4 of Rout et al., arXiv:2401.08588, alternated rather than set side by side.',
          },
        ],
      ...
      },
      {
        ...
        figure: {
          ...
          width: 480,
          height: 270,
          alt: 'Eleven ink dots on warm paper joined by a tangled closed path, which untangles step by step into a short loop through every dot.',
      ...
      },
      {
        ...
        figures: [
          ...
          {
            kind: 'image',
            src: '/assets/media/ant-pybullet.gif',
            poster: '/assets/media/ant-pybullet-poster.webp',
            width: 252,
            height: 180,
            alt: 'A PyBullet Ant robot with four coloured legs walking across a blue and white checkered floor.',
            caption: 'The PyBullet Ant, five seconds of one rollout.',
            scope: 'One recorded rollout from a course exercise, cropped and slowed to 8 fps.',
          },
        ],
  ...
  ryoushi: {
    ...
    projects: [
      ...
      },
      {
        ...
        figure: {
          kind: 'image',
          src: '/assets/media/labs-barker.gif',
          poster: '/assets/media/labs-barker-poster.webp',
          width: 640,
          height: 360,
          alt: 'Thirteen ink squares flip one at a time while twelve autocorrelation bars shrink, ending at the Barker sequence with every bar within ±1.',
          caption: 'Tabu search on the 13-bit LABS problem, one flip a step, from energy 302 down to 6: the Barker sequence.',
          scope: 'A classical tabu search from a random start, computed for this figure. In the team’s workflow, CUDA-Q samples seed the classical search instead.',
        },
      ...
      { 
        ...
        figure: {
          ...
          width: 400,
          height: 225,
          alt: 'Two groups of short ink ticks on warm paper, with a circle drawn around one group.',
          caption: 'A row of ink ticks splits into two groups, and a circle is drawn around one of them.',
          scope: 'Generated illustration of the method, not a capture.',
        },
      ...
      { 
        ...
        figure: {
          kind: 'image',
          src: '/assets/media/shor-algorithm.gif',
      ...
      { 
        ...
        figure: {
          kind: 'image',
          src: '/assets/media/sqd-krylov.gif',
          ...
          scope: 'Animated schematic with illustrative bitstrings and energy levels. The closing −2.15 eV is not recorded in the team’s repository; the −2.2 eV DFT reference is a literature value its script compares against.',
        },
      ...
      },
      {
        ...
        figure: {
          kind: 'image',
          src: '/assets/media/surface-code-decode.gif',
      ...
      },
      {
        ...
        figure: {
          ...
          width: 400,
          height: 225,
          alt: 'Three ink circuit lines on warm paper with a box on the middle line, and a grey wash that sweeps down across their ends.',
          caption: 'A grey wash sweeps across the ends of three ink circuit lines, then drains away.',
          scope: 'Generated illustration of the method, not a capture.',
        },
