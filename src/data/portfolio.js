...
export const DATA = {
  ryukijano: {
    ...
    projects: [
      ...
      { 
        ...
        link: "#", 
        icon: Trophy,
        media: { type: 'image', src: '/assets/images/doom_ppo.webp' },
  ...
  ai: {
    id: 'ai',
    title: "Gyanateet",
    subtitle: "AI Researcher · Vision & Robotics",
    desc: "MSc CS & AI @ Leeds. Self-supervised vision for medical imaging, vision-language-action robotics, and generative models.",
    fullDesc: "Vision research intern at the University of Leeds building practical AI systems: self-supervised learning (DINO, DINOv2, V-JEPA) for medical imaging, vision-language-action policies for robotics, and 3D reconstruction with NeRFs and Gaussian Splatting. Published researcher in computer vision and optimization.",
    ...
    projects: [
      ...
      { 
        ...
        icon: Database,
        media: { type: 'image', src: '/assets/images/diffusion.webp' },
      ...
      },
      {
        ...
        icon: Cpu,
        media: { type: 'image', src: '/assets/images/ant_bullet.webp' },
  ...
  ryoushi: {
    ...
    fullDesc: "Quantum computing researcher, Qiskit Advocate, and co-founder of Quantum Buddies, a research collective advancing quantum machine learning, quantum attention mechanisms, and hybrid quantum-classical algorithms. Multiple hackathon winner with expertise in VQE, QAOA, quantum walks, and quantum error correction.",
    tags: ["Qiskit Advocate", "PennyLane", "Quantum ML", "CUDA-Q", "QEC"],
    ...
    projects: [
      ...
      {
        title: "NVIDIA iQuHACK 2026",
        desc: "Team Cubits — NVIDIA's quantum computing hackathon challenge.",
        fullDesc: "Competed in NVIDIA's iQuHACK 2026 quantum hackathon as part of Team Cubits, working on GPU-accelerated quantum computing with CUDA-Q / cuQuantum.",
        link: "https://github.com/Ryukijano/2026-NVIDIA",
        icon: Zap,
        media: { type: 'image', src: '/assets/images/command-line__2_.jpg' },
        tags: ["NVIDIA", "iQuHACK", "CUDA-Q", "cuQuantum"]
      },
      {
