  ...
  bands: [
    {
      ...
      cards: [
        ...
        },
        {
          ...
          b: 'the system is small enough. under roughly twenty-eight qubits the reference is exact and the answer can be checked outright. past that the memory runs out, the reference becomes an approximation, and exact starts meaning exact only within the simplified model. the hardware runs prove the circuit executed cleanly. they say nothing about whether the energy was right.',
