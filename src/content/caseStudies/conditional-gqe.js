...
const study = {
  ...
  lead:
    "To work out a molecule's energy on a quantum computer you first have to guess the shape of the circuit, and someone has to guess that by hand, per molecule. This learns to propose the shape from the molecule itself, and leaves the fine-tuning to a classical optimiser that is better at it.",
  ...
  sections: {
      ...
      tableRows: [
        ...
        },
        {
          ...
          cells: [
            '8q',
            '87.5%',
            'how cleanly real hardware ran the circuit; it says nothing about whether the energy was right',
          ],
        },
        {
    ...
    checkIt: {
      ...
      caption:
        'The Hamiltonian here is a toy: its coefficients are chosen, not taken from a molecule. That does not weaken the demonstration, because the vanishing gradient is a property of diagonal operators acting on a computational basis state, and holds for any Hamiltonian whatsoever.',
