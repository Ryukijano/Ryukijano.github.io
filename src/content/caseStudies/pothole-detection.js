...
const study = {
  ...
  hero: {
    ...
    caption:
      'The pipeline in order: a dashcam frame is decimated to a fraction of its resolution, ESRGAN restores it ×4, then YOLOv7 runs detection on the restored frame. This is a schematic of the pipeline on procedural road texture; it is not a figure from the paper and not measured output.',
