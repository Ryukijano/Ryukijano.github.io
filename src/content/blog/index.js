...
export const curriculum = [
  ...
  { slug: 'video-language', layer: 'Video-language', changes: 'caption or action' },
  { slug: 'post-training', layer: 'Post-training', changes: 'policy' },
  { slug: 'diffusion-objectives', layer: 'Diffusion', changes: 'noisy action chunks' },
  { slug: 'agent-skills', layer: 'Skills', changes: 'a file, not weights' },
  { slug: 'qec-learning', layer: 'QEC', changes: 'hidden-state inference' },
  { slug: 'qec-supervision', layer: 'Supervision', changes: 'what the decoder may know' },
  { slug: 'circuit-search', layer: 'Search', changes: 'energy as a reward' },
];
